...
class UNetWithResnet50Encoder(nn.Module):
    def __init__(self, n_classes=22):
        ...
        self.layer1 = nn.Sequential(
            nn.Conv2d(in_channels=3, out_channels=64, kernel_size=7, stride=2, padding=3),#blank#, #blank#, #blank#, #blank#, #blank# ), # Code overlaps with previous assignments
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True)#,
        )
        ...
        self.layer2 = nn.Sequential(
            ResidualBlock(64, 64, 256),#blank#, #blank#, #blank#),
            ResidualBlock(256, 64, 256),#blank#, #blank#, #blank#),
            ResidualBlock(256, 64, 256, downsample = True),#blank#, #blank#, #blank#, downsample=True) # Code overlaps with previous assignments
        )
        self.layer3 = nn.Sequential(
            ResidualBlock(256, 128, 512),#blank#, #blank#, #blank#),
            ResidualBlock(512, 128, 512),#blank#, #blank#, #blank#),
            ResidualBlock(512, 128, 512),#blank#, #blank#, #blank#),
            ResidualBlock(512, 128, 512),#blank#, #blank#, #blank#, downsample=False) # Code overlaps with previous assignments
        )
